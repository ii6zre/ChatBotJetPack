...
@Composable
fun HomeScreen(uiState: HomeUiState = HomeUiState.Loading,
    ...
    val imageUris = rememberSaveable(saver = UiCustomSaver()) {
        mutableStateListOf()
    }
    ...
    Scaffold (
        topBar = {
            TopAppBar(title = { Text(text = "Caku Ai Chatbot")},
            ...
            Column{
                Row(modifier = Modifier.padding(vertical = 16.dp),
                    ...
                    IconButton(onClick = {
                        ...
                        Icon(imageVector = Icons.Default.AccountCircle, contentDescription ="Add Image")
                    }
